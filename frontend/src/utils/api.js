...
// Pointing to the live Render backend to resolve local auth issues.
const API_BASE = import.meta.env.VITE_API_BASE_URL || 'https://breathometer6-0-4ago.onrender.com';
