      ...
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-8 sm:p-12 border border-slate-200">
        ...
        <div className="space-y-6 text-slate-600 leading-relaxed">
          ...
          <section>
            ...
            <p>
              If you have any questions or concerns about this Privacy Policy, your rights, or our data handling practices, please contact our Data Protection Officer at privacy@breathometer.com.
            </p>
          </section>
        </div>
      </div>
